#include <jni.h>
#include "org_bulldog_beagleboneblack_jni_NativeTools.h"


/*
 * Class:     org_bulldog_beagleboneblack_jni_NativeTools
 * Method:    getJavaDescriptor
 * Signature: (I)[Ljava/io/FileDescriptor
 */
JNIEXPORT jobject JNICALL Java_org_bulldog_beagleboneblack_jni_NativeTools_getJavaDescriptor
